...
const routes: Routes = [
  ...
  { path: 'dashboard',
  // canActivateChild: [EnumeratorRoutesGuard], canLoad: [EnumeratorRoutesGuard],
  loadChildren: () => import('./enumerator-dashboard/enumerator-dashboard.module').then(m => m.EnumeratorDashboardModule)}
];
